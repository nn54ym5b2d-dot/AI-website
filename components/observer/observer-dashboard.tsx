      ...
      {dashboard ? <>
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="ui-panel p-5">
            <h2 className="font-bold text-ink">收入汇总</h2>
            <p className="mt-1 text-xs text-muted">收入合计 = 交易收益 + 上传收益</p>
            <dl className="mt-4 grid gap-3 text-sm">
              <div className="flex justify-between gap-4"><dt className="text-muted">交易收益</dt><dd className="font-semibold text-ink">{money(dashboard.revenue.transactionRevenueCents)}</dd></div>
              <div className="flex justify-between gap-4"><dt className="text-muted">上传收益</dt><dd className="font-semibold text-ink">{money(dashboard.revenue.uploadRevenueCents)}</dd></div>
              <div className="flex justify-between gap-4 border-t border-line pt-3"><dt className="font-semibold text-ink">收入合计</dt><dd className="text-lg font-bold text-ink">{money(dashboard.revenue.transactionRevenueCents + dashboard.revenue.uploadRevenueCents)}</dd></div>
            </dl>
          </article>
