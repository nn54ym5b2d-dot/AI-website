...
export default async function DownloadsPage() {
  ...
  return <PageShell actions={<SecondaryLink href="/account">返回个人中心</SecondaryLink>} description="365 天平台资格可重复使用；每次实际下载都会重新签发短时 ZIP 地址并记录。" eyebrow="My workspace" title="我的下载"><DownloadWorkspace history={history} links={links} /></PageShell>;
}
