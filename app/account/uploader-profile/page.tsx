...
export default async function UploaderProfilePage() {
  ...
  return <PageShell actions={<SecondaryLink href="/account">返回个人中心</SecondaryLink>} description="维护真实上传者展示名称和简介；邀请码明文不会在此回显。" eyebrow="My workspace" title="上传者资料"><UploaderProfileForm initialProfile={await getUploaderProfile(access)} /></PageShell>;
}
