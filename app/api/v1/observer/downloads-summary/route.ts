...
import { getObserverDownloadsSummary, resolveObserverPeriod } from "@/lib/observer/metrics";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return apiSuccess(await getObserverDownloadsSummary(access, period), requestId);
