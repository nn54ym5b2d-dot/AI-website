...
import { getObserverRevenueSummary, resolveObserverPeriod } from "@/lib/observer/metrics";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return apiSuccess(await getObserverRevenueSummary(access, period), requestId);
