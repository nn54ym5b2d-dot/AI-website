...
import { getObserverAssetsSummary, resolveObserverPeriod } from "@/lib/observer/metrics";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return apiSuccess(await getObserverAssetsSummary(access, period), requestId);
