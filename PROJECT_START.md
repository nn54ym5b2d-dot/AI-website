...
- T015 / Issue #10 已实现受约束的用户角色/状态管理、最后一名有效超级管理员保护、观察员账号生命周期、六个只读聚合接口与真实 `/observer` 看板；隔离 PostgreSQL 自动化测试 27/27、lint、typecheck、生产构建及桌面/390×844 浏览器复核均通过，当前等待 Robert 验收。
