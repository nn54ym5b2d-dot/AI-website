...
- T011 / Issue #6 已在分支 `codex/t011-uploader-submission` 完成本地实现并通过草稿 PR #30 进入 Review：人物独立表单、物件/场景共用表单、草稿创建/编辑、上传意图、暂存到不可变最终 key、重复完成幂等、私有人物证明材料、独立水印预览/缩略对象元数据、认证费待支付和提交幂等均已落地；真实 COS、图片处理、CDN 和认证费支付仍未接入。
