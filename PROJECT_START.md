...
- T008 核心 API 第一版接口合同已完成，覆盖 `/api/v1` 规范、Cookie 会话与 CSRF、角色权限、COS 直传、支付回调、授权下载、收益、后台和外部观察员边界，当前等待 Robert 通过 PR 审核。
...
1. Robert 审核并合并 GitHub Issue #3 / T008 对应的 Pull Request。
...
- Robert 是否确认 T008 核心 API 已完整对应数据结构、价格、分成、授权、下载、退款和角色边界。
